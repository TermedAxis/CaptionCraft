  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex items-center gap-2.5 pl-1 pr-3 py-1.5 rounded-xl hover:bg-gray-50 transition group"
      >
        ...
        <div className="text-left hidden sm:block">
          <p className="text-sm font-semibold text-gray-900 leading-tight">{profile?.full_name ?? 'Account'}</p>
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-56 bg-white border border-gray-200 rounded-xl shadow-lg z-50 overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-100 bg-gray-50">
            <p className="text-sm font-semibold text-gray-900 truncate">{profile?.full_name ?? 'Account'}</p>
            ...
            <div className="mt-2 flex items-center gap-1.5">
              {plan !== 'free' && planConfig.icon ? (
                ...
                <span className="text-xs font-semibold text-gray-500 bg-gray-200 px-2 py-0.5 rounded-full">Free Plan</span>
              )}
            </div>
          </div>
          ...
          {plan !== 'free' && (
            <div className="px-4 py-3 border-b border-gray-100">
              ...
              <button
                ...
                className="mt-2 w-full flex items-center justify-center gap-1.5 text-xs font-medium text-blue-600 hover:text-blue-700 hover:bg-blue-50 rounded-lg py-1.5 transition"
              >
          ...
          <div className="px-2 py-2">
            <button
              ...
              className="w-full flex items-center gap-2.5 px-3 py-2 text-sm text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-lg transition"
            >
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-0.5 flex-1 justify-center overflow-x-auto">
              {navItems.map(({ id, label, icon: Icon }) => (
                ...
                >
                  <Icon className={`w-5 h-5 flex-shrink-0 ${currentPage === id ? 'text-blue-600' : 'text-gray-400'}`} />
              ...
              {user ? (
                <>
                  {plan === 'free' ? (
                    ...
                    <div className="hidden sm:flex items-center gap-1.5 px-3 py-2 bg-amber-50 border border-amber-200 rounded-xl">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-xl transition"
                  >
                    Sign In
                  </button>
                  <button
