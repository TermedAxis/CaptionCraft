...
function TypeWriter({ texts }: { texts: string[] }) {
  ...
  return (
    <span className="text-blue-600">
      ...
      <span className="inline-block w-0.5 h-10 bg-blue-600 ml-1 animate-pulse align-middle" />
    </span>
  );
}
    ...
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
      ...
      <div className="p-5">
        <div className="text-xs text-gray-400 mb-2 flex items-center gap-1.5">
          <Sparkles className="w-3 h-3 text-blue-500" /> Topic: Morning routine tips
        </div>
        <p className="text-sm text-gray-800 leading-relaxed whitespace-pre-line">{caption}</p>
        <p className="text-sm text-blue-500 mt-3">{tags}</p>
        <button
          onClick={handleCopy}
          className="mt-4 flex items-center gap-1.5 px-3.5 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-600 hover:bg-gray-100 transition"
        >
    ...
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
      <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-sm font-semibold text-gray-800">YouTube Script · Short (60s)</span>
        </div>
        <span className="text-xs text-gray-500 bg-gray-50 px-2.5 py-1 rounded-full">~140 words</span>
      </div>
      <div className="p-5 space-y-3">
        <div>
          <span className="text-xs font-semibold text-orange-600 uppercase tracking-wide">Hook (0–5s)</span>
          <p className="text-sm text-gray-800 mt-1 leading-relaxed">"Most people think going viral is luck. It's not — it's a formula. And today I'm giving it to you for free."</p>
        </div>
        <div>
          <span className="text-xs font-semibold text-blue-600 uppercase tracking-wide">Main Content</span>
        ...
        <div>
          <span className="text-xs font-semibold text-green-600 uppercase tracking-wide">CTA</span>
          <p className="text-sm text-gray-800 mt-1">"Subscribe for part 2 — I'm breaking down the exact hook formula that got me 2M views."</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
      <div className="px-5 py-4 border-b border-gray-100 flex items-center gap-2.5">
        ...
        <span className="text-sm font-semibold text-gray-800">Carousel · 4 Slides</span>
      ...
      <div className="p-5">
        <div className="text-xs text-gray-400 mb-3 flex items-center gap-1.5">
          <Sparkles className="w-3 h-3 text-green-500" /> Topic: How to grow your audience in 30 days
        </div>
        <div className="grid grid-cols-2 gap-2">
          {slides.map(slide => (
            <div key={slide.num} className="border border-gray-100 rounded-xl p-3 bg-gray-50">
              <span className="text-xs font-bold text-gray-300">{slide.num}</span>
              <p className="text-xs font-semibold text-gray-800 mt-1">{slide.title}</p>
              <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">{slide.body}</p>
            </div>
          ))}
        </div>
      </div>
...
function ThumbnailDemo() {
  const concepts = [
    { bg: 'from-blue-600 to-blue-800', title: '10 Habits That Changed My Life', emoji: '⚡', label: 'Bold Yellow Text' },
    { bg: 'from-gray-900 to-gray-700', title: 'I Tried Waking Up at 5AM for 30 Days', emoji: '🌅', label: 'Cinematic Dark' },
    { bg: 'from-orange-500 to-red-600', title: 'The Productivity Secret Nobody Talks About', emoji: '🔑', label: 'High Energy' },
  ];
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
      <div className="px-5 py-4 border-b border-gray-100 flex items-center gap-2.5">
        ...
        <span className="text-sm font-semibold text-gray-800">Thumbnail Concepts · 3 Options</span>
      </div>
    ...
    <div className="min-h-screen bg-white text-gray-900 overflow-x-hidden">
      ...
      <nav className="sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-gray-100">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center max-w-6xl">
          ...
          <button onClick={onGetStarted} className="bg-gray-900 text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-gray-700 transition">
            Start Free
          </button>
        </div>
      </nav>
      ...
      <section className="relative pt-20 pb-28 px-6 overflow-hidden bg-white">
        {/* Background grid */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:64px_64px] opacity-50" />
        {/* Gradient blob */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[500px] bg-blue-50 rounded-full opacity-60 blur-3xl -z-0" />
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-gray-900 leading-[1.06] tracking-tight mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-8">
            <button onClick={onGetStarted} className="inline-flex items-center justify-center gap-2 bg-gray-900 text-white px-8 py-4 rounded-xl text-base font-semibold hover:bg-gray-700 transition shadow-sm">
              Start Creating for Free
              <ArrowRight className="w-4 h-4" />
            </button>
            <a href="#features" className="inline-flex items-center justify-center gap-2 border border-gray-200 text-gray-700 px-8 py-4 rounded-xl text-base font-semibold hover:bg-gray-50 transition">
              See the Features
            </a>
          </div>
          <p className="text-sm text-gray-400">No credit card required · 50 free credits · Cancel anytime</p>
          ...
          <div className="mt-16 relative">
            <div className="bg-white border border-gray-200 rounded-2xl shadow-2xl shadow-gray-200/80 overflow-hidden">
              <div className="flex items-center gap-2 px-5 py-3 border-b border-gray-100 bg-gray-50">
                ...
                <div className="flex-1 bg-white border border-gray-200 rounded-md px-3 py-1 text-xs text-gray-400 font-mono mx-4">app.mediawizard.com/caption-creator</div>
              </div>

              {/* Fake dashboard layout */}
              <div className="flex min-h-[400px]">
                {/* Sidebar */}
                <div className="w-14 bg-gray-50 border-r border-gray-100 flex flex-col items-center py-4 gap-3">
                  {[LayoutGrid, MessageSquare, ScrollText, Image].map((Icon, i) => (
                    <div key={i} className={`w-8 h-8 rounded-lg flex items-center justify-center ${i === 1 ? 'bg-blue-600 text-white' : 'text-gray-400 hover:bg-gray-200'}`}>
                      <Icon className="w-4 h-4" />
                    </div>
                  ))}
                </div>
                {/* Form column */}
                <div className="flex-1 p-6 border-r border-gray-100 max-w-xs space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-1.5">
                    {['Instagram', 'TikTok', 'LinkedIn', 'Twitter'].map((p, i) => (
                      <div key={p} className={`px-2.5 py-1.5 rounded-lg text-xs font-medium border ${i === 0 ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-gray-600 border-gray-200'}`}>{p}</div>
                    ))}
                  </div>
                  <p className="text-xs font-semibold text-gray-400 uppercase tracking-widest">Topic</p>
                  <div className="border border-blue-300 rounded-lg px-3 py-2 text-xs text-gray-800 bg-blue-50 ring-2 ring-blue-100">
                  ...
                  <div className="grid grid-cols-3 gap-1.5">
                    {['Casual', 'Bold', 'Educational'].map((t, i) => (
                      <div key={t} className={`px-2 py-1.5 rounded-lg text-xs font-medium border text-center ${i === 0 ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-gray-600 border-gray-200'}`}>{t}</div>
                    ))}
                  </div>
                ...
                <div className="flex-1 p-6 space-y-3">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-xs font-semibold text-blue-600 bg-blue-50 px-2.5 py-1 rounded-full">Version A</span>
                    <span className="text-xs text-green-600 bg-green-50 px-2.5 py-1 rounded-full flex items-center gap-1"><CheckCircle className="w-3 h-3" /> 1.1s</span>
                  </div>
                  <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
                    <p className="text-sm text-gray-800 leading-relaxed">
                      <span className="font-semibold text-blue-600">Your 5 AM is your edge.</span> While the world sleeps, you compound. Here's my non-negotiable morning routine — and why it changed everything. 👇
                    </p>
                    <p className="text-xs text-blue-500 mt-2">#MorningRoutine #Productivity #CreatorLife</p>
                  </div>
                  <div className="flex items-center gap-2 mb-1 mt-3">
                    <span className="text-xs font-semibold text-blue-600 bg-blue-50 px-2.5 py-1 rounded-full">Version B</span>
                  </div>
            ...
            {/* Floating badges */}
            <div className="absolute -left-4 top-1/3 bg-white border border-gray-200 rounded-xl px-3.5 py-2.5 shadow-lg hidden lg:flex items-center gap-2">
              <Zap className="w-4 h-4 text-amber-500" />
              <div>
                <p className="text-xs font-bold text-gray-900">Generated in 1.2s</p>
                <p className="text-xs text-gray-400">1 credit used</p>
              </div>
            </div>
            <div className="absolute -right-4 bottom-1/4 bg-white border border-gray-200 rounded-xl px-3.5 py-2.5 shadow-lg hidden lg:flex items-center gap-2">
              <TrendingUp className="w-4 h-4 text-green-500" />
              <div>
                <p className="text-xs font-bold text-gray-900">+40% Engagement</p>
            ...
            {TESTIMONIALS.map((t) => (
              <div key={t.name} className="bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-md transition-shadow">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full bg-gray-900 text-white flex items-center justify-center text-xs font-bold flex-shrink-0">{t.avatar}</div>
                  <div>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-500 mb-16 leading-relaxed">You know you need to post. You open the app. You stare. You close the app. Sound familiar?</p>
          <div className="grid md:grid-cols-3 gap-6 text-left">
            {[
              { icon: Clock, title: 'Hours lost writing', body: "The average creator spends 4+ hours per week just writing captions and scripts. That's time you could spend actually creating.", bg: 'bg-red-50', color: 'text-red-500' },
              { icon: TrendingUp, title: 'Engagement that flatlines', body: 'Generic captions get ignored. Platform algorithms punish low engagement. You need copy that hooks — not filler.', bg: 'bg-orange-50', color: 'text-orange-500' },
              { icon: FileText, title: 'Content calendar chaos', body: 'Staying consistent across 3+ platforms without a system is a full-time job. Most creators burn out in 90 days.', bg: 'bg-amber-50', color: 'text-amber-600' },
            ].map(({ icon: Icon, title, body, bg, color }) => (
              <div key={title} className="border border-gray-200 rounded-2xl p-6 hover:border-gray-300 transition">
      ...
      <section id="features" className="py-24 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">Everything a modern creator needs — without switching between ten different apps.</p>
          </div>
            ...
            {FEATURE_TABS.map(({ id, label, icon: Icon, iconBg, iconColor }) => (
              ...
              >
                <div className={`w-5 h-5 ${iconBg} rounded-md flex items-center justify-center ${activeFeatureTab === id ? 'opacity-90' : ''}`}>
                  <Icon className={`w-3 h-3 ${activeFeatureTab === id ? 'text-white' : iconColor}`} />
                </div>
                {label}
              </button>
            ))}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 mt-16">
            {[
              { icon: MessageSquare, bg: 'bg-pink-50', color: 'text-pink-600', title: 'Caption Creator', badge: 'Most Popular', desc: 'Scroll-stopping captions for any platform, tone, and niche.', platforms: ['Instagram', 'TikTok', 'Twitter', 'LinkedIn'] },
              { icon: ScrollText, bg: 'bg-orange-50', color: 'text-orange-600', title: 'Script Generator', badge: null, desc: 'Hook-first structured scripts for YouTube, Reels, and Shorts.', platforms: ['YouTube', 'Reels', 'TikTok', 'Shorts'] },
              { icon: LayoutGrid, bg: 'bg-green-50', color: 'text-green-600', title: 'Content Planner', badge: null, desc: 'Full carousels, threads, and social posts generated in one click.', platforms: ['Instagram', 'LinkedIn', 'Twitter'] },
              { icon: Image, bg: 'bg-rose-50', color: 'text-rose-600', title: 'Thumbnail Generator', badge: 'New', desc: 'Professional thumbnail concepts that drive clicks instantly.', platforms: ['YouTube', 'Shorts'] },
            ].map((f) => (
              <div key={f.title} className="border border-gray-200 rounded-2xl p-6 hover:border-gray-300 hover:shadow-sm transition-all group">
                <div className="flex items-start justify-between mb-4">
                  <div className={`w-10 h-10 ${f.bg} rounded-xl flex items-center justify-center`}>
                    <f.icon className={`w-5 h-5 ${f.color}`} />
                  </div>
                  {f.badge && <span className="text-xs font-semibold bg-gray-900 text-white px-2.5 py-1 rounded-full">{f.badge}</span>}
                </div>
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {PLATFORMS_LIST.map(({ name, icon: Icon, color, bg }) => (
              <div key={name} className="flex flex-col items-center gap-2.5 group cursor-default">
                <div className={`w-14 h-14 ${bg} rounded-2xl flex items-center justify-center shadow-sm border border-white group-hover:scale-110 transition-transform`}>
      ...
      <section id="how-it-works" className="py-24 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight">From idea to post in 60 seconds</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8 relative">
            {/* Connector line */}
            <div className="hidden md:block absolute top-8 left-[calc(16.67%)] right-[calc(16.67%)] h-px bg-gray-200 z-0" />
            {[
              { number: '01', icon: Zap, title: 'Enter your idea', body: "Type a few words about what you want to create. No lengthy prompts needed — Media Wizard figures out the rest.", bg: 'bg-blue-50', color: 'text-blue-600' },
              { number: '02', icon: Sparkles, title: 'AI generates instantly', body: 'Platform-optimized content in seconds. Captions, scripts, posts, thumbnails — all in one place.', bg: 'bg-green-50', color: 'text-green-600' },
              { number: '03', icon: CheckCircle, title: 'Copy, tweak & post', body: 'Adjust anything with one click. Save your favorites and publish to your workflow.', bg: 'bg-orange-50', color: 'text-orange-600' },
            ].map((step) => (
              <div key={step.number} className="text-center relative z-10">
                <div className={`w-16 h-16 ${step.bg} rounded-2xl flex items-center justify-center mx-auto mb-5 border-4 border-white shadow-sm`}>
      ...
      <section id="pricing" className="py-24 px-6 bg-gray-50 border-t border-gray-200">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight">Start free. Scale when you're ready.</h2>
            <p className="text-gray-500 mt-4 text-lg">No hidden fees. No subscriptions that trap you. Just results.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {PLANS.map((plan) => (
              <div key={plan.name} className={`rounded-2xl p-8 border relative ${plan.highlight ? 'bg-gray-900 text-white border-gray-900 shadow-2xl shadow-gray-900/20 scale-105' : 'bg-white border-gray-200'}`}>
                {plan.highlight && (
                ...
                <button onClick={onGetStarted} className={`w-full py-3 rounded-xl font-semibold transition text-sm ${plan.highlight ? 'bg-white text-gray-900 hover:bg-gray-100' : 'bg-gray-900 text-white hover:bg-gray-700'}`}>
                  {plan.cta}
                </button>
              </div>
            ))}
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start gap-10 mb-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
              ...
              <div>
                <p className="font-semibold text-gray-900 mb-3">Niches</p>
                <ul className="space-y-2 text-gray-500">
