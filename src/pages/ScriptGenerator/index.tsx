      ...
      <div className="mb-8 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Generate video scripts for any platform</p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center py-20 text-gray-400">
              ...
              <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Writing your script...</p>
          ...
          {!loading && variations.length === 0 && !error && (
            <div className="flex flex-col items-center justify-center py-20 text-center">
              <div className="p-4 bg-gray-100 dark:bg-gray-800 rounded-2xl mb-4">
                <ScrollText className="w-8 h-8 text-gray-400 dark:text-gray-500" />
              </div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Your script will appear here</p>
              <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Fill in the form and click Generate</p>
            </div>
          )}
        </div>
      </div>
